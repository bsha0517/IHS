  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-semibold tracking-tight">Register closed</h1>
      ...
      <Card>
        ...
        <CardContent className="grid gap-2 text-sm sm:grid-cols-2">
          ...
          <p className="flex items-center gap-2">
            ...
            <Badge variant={Number(cashierSession.variance) === 0 ? "default" : "destructive"}>{varianceLabel}</Badge>
          </p>
        </CardContent>
      </Card>
